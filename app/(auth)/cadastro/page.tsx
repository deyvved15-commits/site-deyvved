  ...
  return (
    <>
      <style>{`
        ...
        .divider-line { flex: 1; height: 1px; background: rgba(201,169,122,0.12); }
        .corner {
          position: absolute;
          width: 36px;
          height: 36px;
          ...
          <div style={{
            ...
            <form onSubmit={handleSubmit} className="cad-card" style={{ padding: "24px 24px 28px", display: "flex", flexDirection: "column", gap: 16 }}>
              ...
              <div style={{ display: "flex", alignItems: "center", gap: 12, margin: "4px 0" }}>
                ...
                <span style={{ fontFamily: "'Cinzel',serif", fontSize: 8, letterSpacing: 3, color: "rgba(201,169,122,0.30)", textTransform: "uppercase", whiteSpace: "nowrap" }}>ou cadastre-se com</span>
                <span className="divider-line" />
              </div>
