  ...
  return (
    <div style={{ minHeight: "100vh", background: "#050A1F", padding: "40px 20px", display: "flex", flexDirection: "column", alignItems: "center" }}>
      ...
      <div className="no-print" style={{ 
        ...
        <div>
          <h2 style={{ fontFamily: "'Cinzel',serif", fontSize: 16, color: "var(--gold)", margin: 0 }}>Certificado Disponível</h2>
        ...
        <button 
          ...
          style={{ 
            ...
            background: "var(--gold)", color: "#060D1F", border: "none", borderRadius: 10, 
            fontFamily: "'Cinzel',serif", fontWeight: 700, fontSize: 12, cursor: "pointer",
            boxShadow: "0 4px 14px rgba(201,169,122,0.4)"
          }}
        >
      ...
      <div className="certificate-container" style={{
        ...
        background: "white", color: "#1a1a1a", position: "relative",
        ...
        {/* Frame / Borders */}
        <div style={{ position: "absolute", inset: 20, border: "2px solid #C9A97A", pointerEvents: "none" }} />
        <div style={{ position: "absolute", inset: 28, border: "1px solid #E8D5A8", pointerEvents: "none" }} />

        {/* Header */}
        <div style={{ marginBottom: 40 }}>
          <div style={{ display: "flex", justifyContent: "center", marginBottom: 20 }}>
             <Award size={64} color="#C9A97A" strokeWidth={1} />
          </div>
          <h3 style={{ fontFamily: "'Cinzel',serif", fontSize: 14, letterSpacing: 6, textTransform: "uppercase", color: "#C9A97A", margin: 0 }}>
            Kadima Academy
          </h3>
          <div style={{ width: 40, height: 2, background: "#C9A97A", margin: "16px auto" }} />
        ...
        {/* Footer */}
        <div style={{ width: "100%", display: "flex", justifyContent: "space-between", alignItems: "flex-end", marginTop: 40 }}>
        ...
        {/* Decorative Corners */}
        <div style={{ position: "absolute", top: 10, left: 10, width: 60, height: 60, borderTop: "4px solid #C9A97A", borderLeft: "4px solid #C9A97A" }} />
        <div style={{ position: "absolute", top: 10, right: 10, width: 60, height: 60, borderTop: "4px solid #C9A97A", borderRight: "4px solid #C9A97A" }} />
        <div style={{ position: "absolute", bottom: 10, left: 10, width: 60, height: 60, borderBottom: "4px solid #C9A97A", borderLeft: "4px solid #C9A97A" }} />
        <div style={{ position: "absolute", bottom: 10, right: 10, width: 60, height: 60, borderBottom: "4px solid #C9A97A", borderRight: "4px solid #C9A97A" }} />
      </div>
