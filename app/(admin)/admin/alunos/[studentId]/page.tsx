          ...
          {student.phone ? (
            ...
            >
              <div style={{
                ...
                <p style={{ fontFamily: "'Cinzel',serif", fontSize: 9, fontWeight: 600, letterSpacing: 3, textTransform: "uppercase", color: "var(--gold)", marginBottom: 6, display: "flex", alignItems: "center", gap: 6 }}>
                ...
                <p style={{ fontSize: 13, fontWeight: 500, color: "var(--text-primary)" }}>{student.phone}</p>
              </div>
            </a>
          ) : (
            <InfoCard label="WhatsApp" value="—" />
          )}
