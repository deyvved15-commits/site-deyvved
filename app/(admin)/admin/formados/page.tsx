...
export default async function AdminFormadosPage() {
  ...
  return (
    <div style={{ minHeight: "100%", background: "linear-gradient(180deg, var(--navy-darkest) 0%, var(--navy-mid) 100%)" }}>
      ...
      <div className="ka-page-header">
        <div className="ka-page-eyebrow">Gestão Acadêmica</div>
        <h1 className="ka-page-title">Alunos <span>Formados</span></h1>
        <p className="ka-page-subtitle">Visualize e gerencie a emissão de segundas vias de certificados.</p>
      </div>
      ...
      <div className="ka-section">
        {graduates.length === 0 ? (
          <div style={{ textAlign: "center", padding: "100px 40px", background: "rgba(15,26,61,0.5)", borderRadius: 24, border: "1px solid rgba(201,169,122,0.1)" }}>
             ...
             <p style={{ color: "var(--text-muted)", fontSize: 16 }}>Nenhum aluno se formou ainda.</p>
          </div>
        ) : (
